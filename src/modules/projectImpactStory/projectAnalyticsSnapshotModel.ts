...
const projectAnalyticsSnapshotSchema = new Schema(
  {
    ...
    backlogChartPlan: { type: [Schema.Types.Mixed], default: [] },
    goalProgressEntries: { type: [Schema.Types.Mixed], default: [] },
    confirmedOutcomeCharts: { type: [Schema.Types.Mixed], default: [] },

...
const deterministicAnalysisSchema = new Schema(
  {
    ...
    categoricalCrosstabs: { type: [Schema.Types.Mixed], default: [] },
    numericCategorySummaries: { type: [Schema.Types.Mixed], default: [] },
    numericCorrelations: { type: [Schema.Types.Mixed], default: [] },
